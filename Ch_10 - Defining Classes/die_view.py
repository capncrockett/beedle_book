...
class DieView:
    ...
    def __init__(self, win, center, size):
        ...
        half_size = size / 2.0  # half the size of the die
        offset = 0.6 * half_size  # distance from center to outer pips

        # create a square for the face
        cx, cy = center.getX(), center.getY()
        p1 = Point(cx - half_size, cy - half_size)
        p2 = Point(cx + half_size, cy + half_size)
